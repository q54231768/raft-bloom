...
public class Server3 {
    public static void main(String args[]) {
        ...
        RaftLog raftLog = new RaftLog("D:\\raft-log\\test-server\\3");
        ...
        RaftRpcServer raftRpcServer = RaftRpcServer.getRaftRpcServer(9903,raftUserProcessor);
//        RaftRpcServer raftRpcServer = new RaftRpcServer();
//        raftRpcServer.init(9903, raftUserProcessor);
