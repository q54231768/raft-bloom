...
public class Server2 {
    ...
    public static void main(String args[]) {
        ...
        RaftLog raftLog = new RaftLog("D:\\raft-log\\test-server\\2");
        ...
        RaftRpcServer raftRpcServer = RaftRpcServer.getRaftRpcServer(9902, raftUserProcessor);
//        RaftRpcServer raftRpcServer = new RaftRpcServer();
//        raftRpcServer.init(9902, raftUserProcessor);
