...
public class Server1 {
    ...
    public static void main(String args[]) {
        ...
        RaftLog raftLog = new RaftLog("D:\\raft-log\\test-server\\1");
        ...
        RaftRpcServer raftRpcServer = RaftRpcServer.getRaftRpcServer(9901, raftUserProcessor);
//        RaftRpcServer raftRpcServer = new RaftRpcServer();
//        raftRpcServer.init(9901, raftUserProcessor);
